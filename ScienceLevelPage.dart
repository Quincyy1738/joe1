...
class GamePage extends StatefulWidget {
  ...
  GamePage({required this.backgroundColor, required this.onBackgroundColorChanged, required void Function(Color color) onColorChange});
    ...
    setState(() {
      if (gameActive) {
        if (constructedWord.toUpperCase() == currentWord) {
          ...
          _showFeedbackDialog('Your answer is incorrect!');
        }
              ...
              Wrap(
                ...
                children: List.generate(
                  26,
                    ...
                    onPressed: gameActive ? () => _addLetter(String.fromCharCode(index + 65)) : null,
